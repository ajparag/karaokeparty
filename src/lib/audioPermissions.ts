...
export async function requestMicrophone(): Promise<MediaStream> {
  ...
  // Echo cancellation is enabled on ALL platforms.
  //
  // Why we changed from non-iOS=false to non-iOS=true:
  // The app plays reference vocals through speakers while recording the mic.
  // Without AEC, the mic picks up the speaker output, making the scoring
  // engine see the reference vocals as "user singing" — scores rise when
  ...
  //
  // Note: disabling AEC was originally done to improve pitch detection
