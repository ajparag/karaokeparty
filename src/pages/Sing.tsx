...
const Sing = () => {
  ...
  const {
    ...
    currentTime,
    isPlaying,
    // Pass the existing audio element directly so the hook can tap into it
    // without creating a second element — eliminates the race condition where
    // the play-sync effect fired before initRefAnalysis finished creating Audio().
    vocalsAudioElement: vocalsAudioRef.current,
  });
